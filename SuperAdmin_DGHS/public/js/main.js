...
function SendData()
{
  ...
  // alert(name+employee_id+phone_number+email+password+division+district+upazilla+union+word);
  var url = "/HAinsert";
  var data ={name:name,employee_id:employee_id,phone_number:phone_number,email:email,password:password,division:division,district:district,upazilla:upazilla,union:union,word:word};
