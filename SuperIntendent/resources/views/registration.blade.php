...
<div class="container ">
    <section class="registration shadow-lg p-3 mb-5 bg-body rounded row">
        ...
        <div class="col-md-4 img">
            ...
            <h3>Super Intendent Registration</h3>
        </div>
        <div class="col-md-8 px-5 right-panel">
            @if(Session::has('/district/registration'))
                <div class="alert alert-success text-center pt-3" role="alert">
                    {{Session::get('/district/registration')}}
                </div>
            @endif 
            <form>
                <div class="row shadow-sm p-3 mb-5 bg-body rounded ">
                    ...
                    <div class="form-group mt-3">
                        <div class="mt-4">
                            ...
                            <a class="text-info float-end mt-3" href="{{ '/district/login' }}">Already have an Account ? <strong class="text-danger">Login </strong></a>
                        </div>
                    </div> 
                </div>
            </form>
