<section class="left-panel">
    <div class="d-flex sidebar flex-column p-3 " ">
        ...
        <ul class="nav nav-pills flex-column mb-2 shadow">
            <li class="color-li">
                <a class="nav-link  text-white" href="{{ '/district' }}">
            ...
            <li class="color-li">
                <a class="nav-link text-white" href="{{ '/district/vaccine_details' }}">
                    <i class="fas fa-crutch yellow"></i>
                  Vaccine Details
                </a>
            </li>
            <li class="color-li">
                <a class="nav-link text-white" href="{{ '/district/my_profile' }}">
