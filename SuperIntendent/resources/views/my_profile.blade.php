...
<section class="right-panel ">  
    <div class="container">
        <p>Super Intendent / My Profile</p> <hr>
        <div class="my-profile  pt-3">
            ...
            <div class="row shadow-sm p-3 mb-5 bg-body rounded">
                ...
                <div class="d-flex justify-content-center">
                     <a class="btn btn-info " style="width: 20%" href="{{ '/district/edit_profile' }}">Edit</a>
                </div>
            </div>               
            @endforeach
        </div>
        <div class="row shadow-sm p-3 bg-body rounded">
          ...
          <div class=" mt-4 mb-4" id="hide">
                <div class="row">
                    ...
                    <div class="col-md-4 ">
                        @if(Session::has('/district/my_profile'))
                            <div class="alert alert-success text-center pt-3" role="alert">
                                {{Session::get('/district/my_profile')}}
                            </div>
                        @endif 
                        <form method="Post" class="form-group" action="{{ '/district/my_profile' }}">
                            @csrf
