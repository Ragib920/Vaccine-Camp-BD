    ...
    <section class="login-page clearfix ">
       <div class="row">
            ...
            <div class="col-md-6 shadow-lg p-3 mb-5 bg-body rounded pe-5 ps-5 mt-5">
                <h4 class="pt-3 mb-5  d-flex justify-content-center">Super Intendent Login Panel</h4>
                <form class="loginForm">
                    ...
                    <div class="row mt-4 mb-4">
                        ...
                        <div class="form-group col-md-6 pe-3 ps-3">
                            <a  class="btn btn-danger button-width" href="{{ '/district/registration' }}">Registration</a>
                        </div>
