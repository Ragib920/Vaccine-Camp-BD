...
class RegistrationController extends Controller
{
    ...
    function HAregistration(Request $req)
    {
        ...
        if($result==true){
            ...
            return back()->with('/district/registration','Registration Successfull');
        }
        else{
            // return "Registration Failed";
            return back()->with('/district/registration','Registration Failed');
    ...
    function onUpdateHA(Request $req)
    {
        ...
        if($result==true){
            ...
            return back()->with('/district/edit_profile','You have successfully Updated your Profile');

        }
        else{
           
            return back()->with('/district/edit_profile',' You do not change any data');
        }
    }
