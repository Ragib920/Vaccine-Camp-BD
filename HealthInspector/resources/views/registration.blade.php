...
@section('title','Super Intendent Registration')
...
<div class="container ">
    <section class="registration shadow-lg p-3 mb-5 bg-body rounded row">
        ...
        <div class="col-md-4 img">
            ...
            <h3>Health Inspector Registration</h3>
        </div>
        <div class="col-md-8 px-5 right-panel">
            @if(Session::has('/upazilla/registration'))
                <div class="alert alert-success text-center pt-3" role="alert">
                    {{Session::get('/upazilla/registration')}}
                </div>
            @endif 
            <form>
                <div class="row shadow-sm p-3 mb-5 bg-body rounded ">
                    ...
                    <div class="form-group mt-3">
                        <div class="mt-4">
                            ...
                            <a class="text-info float-end mt-3" href="{{ '/upazilla/login' }}">Already have an Account ? <strong class="text-danger">Login </strong></a>
                        </div>
                    </div> 
                </div>
            </form>
