...
class RegistrationController extends Controller
{
    ...
    function HAregistration(Request $req)
    {
        ...
        if($result==true){
            ...
            return back()->with('/upazilla/registration','Registration Successfull');
        }
        else{
            // return "Registration Failed";
            return back()->with('/upazilla/registration','Registration Failed');
    ...
    function onUpdateHA(Request $req)
    {
        ...
        if($result==true){
            ...
            return back()->with('/upazilla/edit_profile','You have successfully Updated your Profile');

        }
        else{
           
            return back()->with('/upazilla/edit_profile',' You do not change any data');
        }
    }
