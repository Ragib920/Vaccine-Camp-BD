...
class LoginController extends Controller
{
    ...
    function onLogin(Request $request){
       ...
       $countValue=UsersModel::where('employee_id','=',$employee_id)->where('password','=',$password)->count();
    ...
    function changePassword(Request $request){
        ...
        $countValue=UsersModel::where('id','=',$id)->where('password','=',$old_password)->count();
         ...
         if($countValue==1){
            ...
            return back()->with('/word/my_profile','Password Succrssfully Changed');
         }
         else{
            return back()->with('/word/my_profile','Old password dose not match');
         }
