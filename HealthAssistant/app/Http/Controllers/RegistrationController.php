...
class RegistrationController extends Controller
{
    ...
    function HAregistration(Request $req)
    {
        ...
        if($result==true){
            ...
            return back()->with('/word/registration','Registration Successfull');
        }
        else{
            // return "Registration Failed";
            return back()->with('/word/registration','Registration Failed');
    ...
    function onUpdateHA(Request $req)
    {
        ...
        if($result==true){
            ...
            return back()->with('/word/edit_profile','You have successfully Updated your Profile');

        }
        else{
           
            return back()->with('/word/edit_profile',' You do not change any data');
        }
    }
    ...
    function child_info_register(Request $req)
    {
        ...
        $result = DB::insert('INSERT INTO `child_information`(`child_name`, `birth_registration_number`, `gender`, `father_name`, `mother_name`, `parents_phone_number`, `employee_id`) VALUES (?,?,?,?,?,?,?)', [$child_name,$birth_registration_number,$gender,$father_name,$mother_name,$parents_phone_number,$employee_id]);

        if($result==true){
            // return "Registration Successfull";
            return back()->with('/word/child_registration','Registration Successfull');
        }
        else{
            // return "Registration Failed";
            return back()->with('/word/child_registration','Registration Failed');
        }
    }
