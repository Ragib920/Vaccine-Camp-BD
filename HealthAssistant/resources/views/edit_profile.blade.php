...
<section class="right-panel ">
    <p>Health Assistant / Edit My Profile</p> <hr>
    ...
    <div class="container ">
        ...
        <section class="edit-profile row">            
            ...
            <div class="col-md-8 px-5 right-panel">
                @if(Session::has('/word/edit_profile'))
                    <div class="alert alert-success text-center pt-3" role="alert">
                        {{Session::get('/word/edit_profile')}}
                    </div>
                 @endif 
                <form>
                    ...
                    <div class="row shadow-lg p-3 mb-5 bg-body rounded ">
                        ...
                        <div class="col-md-6">   
                            ...
                            <div class="form-group mt-3">
                                ...
                                <input id="upazilla" value="{{ $data->upazilla }}" type="text" class="form-control" required >
                            </div>
                            ...
                            <div class="form-group mt-3">
                             ...
                             <div class="form-group mt-3">
                                ...
                                <select id="word" class="form-control" required>
                                    <option selected disabled>{{ $data->word }}</option>
