...
<section class="right-panel ">
    <p>Health Assistant  / My Profile</p> <hr>
                ...
                <div class="col-md-4 p-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <p class="label-data">{{ $data->union }}</p> 
                            <p class="label-data">{{ $data->word }}</p> 
                        </div>
                    </div>
                </div>
                <div class="d-flex justify-content-center">
                     <a class="btn btn-info " style="width: 20%" href="{{ '/word/edit_profile' }}">Edit</a>
                </div>
            </div>               
            @endforeach
        </div>
        <div class="row shadow-sm p-3 bg-body rounded">
          ...
          <div class=" mt-4 mb-4" id="hide">
                <div class="row">
                    ...
                    <div class="col-md-4 ">
                        @if(Session::has('/word/my_profile'))
                            <div class="alert alert-success text-center pt-3" role="alert">
                                {{Session::get('/word/my_profile')}}
                            </div>
                        @endif 
                        <form method="Post" class="form-group" action="{{ '/word/my_profile' }}">
                            @csrf
